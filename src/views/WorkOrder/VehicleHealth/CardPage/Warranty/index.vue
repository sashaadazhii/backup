  ...
  <div class="block__wrapper">
    <div class="warranty__wrapper">
      ...
      <div class="warranty__time">
        <Label icon="i-shutter_speed" iconColor="#3EB3BB" :label="`30 Months`" border class="-shadow" />
        <Label icon="i-timer" iconColor="#3EB3BB" :label="`60 000 KM`" border class="-shadow" />
      </div>
    </div>
    <div class="warranty__wrapper">
