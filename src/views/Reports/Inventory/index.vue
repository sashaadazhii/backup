  ...
  <div class="reports__inner">
    ...
    <div class="table table__wrapper">
      <div class="table__header">
        ...
        <div class="table__header-title">Number Sold</div>
      ...
      <div class="table__main">
        <div v-for="(report, idx) of reports" :key="idx" class="table__row">
          ...
          <div class="table__cell">{{ report.numberSold }}</div>
      ...
      <div class="table__footer">
        ...
        <div class="table__footer-cell">{{ formatter(reports.reduce((sum, current) => sum + current.numberSold, 0)) }}</div>
        <div class="table__footer-cell">{{ formatter(reports.reduce((sum, current) => sum + current.cost, 0) / reports.length) }}</div>
