<template>
  <div class="header__wrapper">
    ...
    <div class="header__nav">
      <router-link v-if="uid !== 'new' && uid !== 'sa-flow' && uid !== 'sa-billing'" class="header__nav-link" :to="`/work-order/${uid}/general`">Settings</router-link>
      ...
      <router-link v-if="uid !== 'new' && uid !== 'tech-flow' && uid !== 'tech-start'" class="header__nav-link" :to="`/work-order/${uid}/finance`"
        >Finance</router-link
      >
    </div>
